...
public class CursoSenaiApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Crispim Luiz ", "12345678910", "c.luiz@fiemg.com.br", TipoCliente.PESSOAFISICA);
		...
		Cliente cli4 = new Cliente(null, "Guilherme araujo", "12345678913", "Guilhermão@hotmail.com", TipoCliente.PESSOAFISICA);
		...
		Cliente cli6 = new Cliente(null, "Antony limera", "12345678915", "Antonão@hotmail.com", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("3412345633", "3412345622"));
		clienteRepository.saveAll(Arrays.asList(cli6));
		
		Cliente cli7 = new Cliente(null, "Eduardo oliveira", "12345678916", "Eduardão@hotmail.com",TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("3412345666", "3412345611"));
		clienteRepository.saveAll(Arrays.asList(cli7));
        
		Cliente cli8 = new Cliente(null, "Thomas Turbano", "12345678917", "Tonão@hotmail.com", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("3412345644", "3412345655"));
		clienteRepository.saveAll(Arrays.asList(cli8));
		
		Cliente cli9 = new Cliente(null, "Tilambo cano", "12345678918", "Tilambão@hotmail.com", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("3412345699", "3412345688"));
		clienteRepository.saveAll(Arrays.asList(cli9));
		
		Cliente cli10 = new Cliente(null, "Richard selvagem", "12345678919", "Richardinho@hotmail.com", TipoCliente.PESSOAFISICA);
